...
## Functions
################################################################################
class DataLoaderFillerNvsR(object):
    ...
    def fill(self, step):
        ...
        dl = DataLoader(
            TensorDataset(*[torch.tensor(d) for d in [X, P]]),
            batch_size=self.kwargs["batch_size"],
            shuffle=True if step == "Traiing" else False,
...
def _define_X_P_electrode(
    ...
    **kwargs,
    ...
    # Converts the dtype of P_el to float16
...
if __name__ == "__main__":
    ...
    dlf = DataLoaderFiller_n_vs_r(**DL_CONF)
