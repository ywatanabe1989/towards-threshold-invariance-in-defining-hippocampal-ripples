...
def calc_ripple_properties(lpath_lfp):
    ...
    lpath_mep_magni_sd_normed = utils.path_converters.LFP_to_MEP_magni(lpath_lfp)
    lpath_ripple_magni_sd_normed = utils.path_converters.LFP_to_ripple_magni(lpath_lfp)
    ...
    mep_magni_sd_normed = utils.general.load(lpath_mep_magni_sd_normed).astype(np.float32).squeeze()
    ripple_magni_sd_normed = utils.general.load(lpath_ripple_magni_sd_normed)\
    ...
    keys_to_delete = ['duration_ms', 'start_pts', 'end_pts', 'LFP',
                      'MEP magni. / SD', 'ripple magni. / SD']
