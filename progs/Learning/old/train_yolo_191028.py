...
from yolo.models_1d import Darknet
...
ap.add_argument("--model_def", default='./07_Learning/yolo/config/yolov3_1d.cfg', help=" ")
ap.add_argument("-mtl", "--use_multitaskloss", action='store_true')
ap.add_argument("-sr", "--samp_rate", default=1000, type=int, help=" ")
ap.add_argument("-msl", "--max_seq_len", default=416, type=int, help=" ")
args = ap.parse_args()
...
def init_dataloaders():
  ...
  keys_to_pack_detect_ripples = ['Xb', 'Tb_label', 'start_sec', 'end_sec']

  kwargs_dl_tra = {'ripples_binary_classification':False,
                   ...
                   'keys_to_pack_detect_ripples':keys_to_pack_detect_ripples,
                   }
...
def init_ripple_detector_NN():
  ...
  model = Darknet(args.model_def).to(m['device'])
