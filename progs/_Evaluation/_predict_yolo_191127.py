...
for i_lfp in range(len(lfps)):
    ...
    '''
    # mf.save_pkl(n_pattern_tot_outputs, '/mnt/md0/proj/_n_pattern_tot_outputs_selected_binary_nms.pkl')
    n_pattern_tot_outputs = mf.load_pkl('/mnt/md0/proj/_n_pattern_tot_outputs_selected_binary_nms.pkl')
     '''
    ...
    spath_ripples = fpath_lfp.replace('.npy', '_ripple_pred_selected_binary_by_yolo.pkl')
