...
def smoothe_onehot(true_labels: torch.Tensor, classes: int, smoothing=0.0):
    """
...
import torch
labels = torch.LongTensor([0, 1, 1, 1, 0])
soft_labels = smoothe_onehot(labels, 2, smoothing=0.1)
loss = LabelSmoothingLoss(2)
