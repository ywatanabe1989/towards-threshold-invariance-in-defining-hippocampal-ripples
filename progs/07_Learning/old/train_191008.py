...
from dataloader_190829 import dataloader_fulfiller
...
def define_parameters():
  ...
  # p['tes_keyword'] = '02'
  p['tes_keyword'] = args.n_mouse_tes
...
# py3 07_Learning/train_190926.py -step -ilr 1e-7 -bf 4 -nmt 01 -archi cnn
# py3 07_Learning/train_190926.py -step -ilr 1e-7 -bf 4 -nmt 01 -archi rnn
# py3 07_Learning/train_190926.py -step -ilr 1e-7 -bf 4 -nmt 01 -archi fft

# py3 07_Learning/train_190926.py -step -ilr 1e-7 -bf 4 -nmt 03 -archi cnn
# py3 07_Learning/train_190926.py -step -ilr 1e-7 -bf 4 -nmt 03 -archi rnn
# py3 07_Learning/train_190926.py -step -ilr 1e-7 -bf 4 -nmt 03 -archi fft

# py3 07_Learning/train_190926.py -step -ilr 1e-7 -bf 4 -nmt 04 -archi cnn
# py3 07_Learning/train_190926.py -step -ilr 1e-7 -bf 4 -nmt 04 -archi rnn
# py3 07_Learning/train_190926.py -step -ilr 1e-7 -bf 4 -nmt 04 -archi fft

# py3 07_Learning/train_190926.py -step -ilr 1e-7 -bf 4 -nmt 05 -archi cnn
# py3 07_Learning/train_190926.py -step -ilr 1e-7 -bf 4 -nmt 05 -archi rnn
# py3 07_Learning/train_190926.py -step -ilr 1e-7 -bf 4 -nmt 05 -archi fft
