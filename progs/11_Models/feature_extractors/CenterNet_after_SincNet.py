...
def mean_filtering_k(waveforms, k=1, s=1, p='none'): # orig, working, but moving averaging would diminish high freq. components
...
class CenterNet1D_after_SincNet(nn.Module):
    ...
    def __init__(self, ):
        ...
        N_filt, Filt_dim, fs = 16, 257, 1000
        ...
        self.block18 = BasicBlock(128, 128)
        self.block19 = BasicBlock(128, 128)
        self.block20 = BasicBlock(128, 128)
